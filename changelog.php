...
<section class="report-section">
    <div class="report-inner">
        ...
        <div class="prose">
            ...
            <p>The whole site got a new look &mdash; modern, restrained, brutalist-leaning &mdash; with <a href="https://vercel.com/font" target="_blank" rel="noopener">Geist</a> for type, a tightened token system, a sticky top nav, and a real light/dark toggle that doesn't flash on first paint. The threat verdict bar, filter chips, ASN range cards, and one-click block-rules tabs were all reorganized to read in roughly the order you'd actually use them.</p>

            <p>It's also a lot lighter. Until this release every visitor was downloading jQuery, jquery.scrollex, jquery.scrolly, browser, breakpoints, util, and main.js &mdash; seven scripts that came in with the original site template years ago and that nothing on the page has called in recent memory. About 110&nbsp;KB of JavaScript and seven extra HTTP requests, gone. Another 90&nbsp;KB of leftover template CSS (spotlight grids, banner overlays, and other nothings ip2geo never used) went with it. The remaining app styles now live in a single stylesheet instead of three. First paint should be snappier, and the codebase is considerably less embarrassing to <code>git clone</code>.</p>
