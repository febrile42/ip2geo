				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
							...
							<p>The community side of ip2geo: a rolling 7-day <a href="/intel.php">Community Block List</a> built from opted-in threat reports. When you run a Threat Report and share your data, the CIDR ranges from your report join an anonymous aggregate. Once enough independent users have reported the same subnet — at least three, with a minimum hit density so coarse ISP blocks don't slip through — it appears on the list. The more users contribute, the more signal the list has.</p>
							<p>The list is public and free. Download it as ready-to-run iptables, ufw, or nginx rules, or as a plain CIDR list for ipset or any other tool. Quality filters are applied throughout: only prefixes of /16 or more specific (at most 65,536 addresses), only ranges with a hit density of at least 0.1% of their address space, and only ranges corroborated by three or more independent reports. The page is APCu-cached for 15 minutes so the HTML doesn't regenerate on every hit; downloads always bypass the cache and pull fresh data. Data rolls off after 52 weeks. 37 tests, 54 assertions covering the consent endpoint, cache logic, and quality filter behavior.</p>
