				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
							...
							<p>When you purchase a Threat Report, the IP addresses you submit and the resulting report are stored securely and linked to your unique report token. Reports are permalinked — they do not expire automatically. If you provide an email address to receive your report, that address is stored alongside your report. You may request deletion of your report at any time by contacting us with your report token; all associated data, including your email address, will be removed promptly. This data is accessible only via your unique report token.</p>
