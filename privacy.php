				...
				<!-- Main -->
					<section id="main" class="wrapper">
						<div class="inner">
							...
							<p>Consent is opt-in only, requested on your report page after generation. Because contributed data is immediately aggregated with no user identifier retained, individual contributions cannot be separated from the aggregate after the fact. Withdrawing consent (contact <a href="mailto:support@ip2geo.org">support@ip2geo.org</a> with your report token) prevents future reports from contributing but does not affect data already in the aggregate. This is consistent with GDPR Recital 26: truly anonymized data is not subject to erasure requirements.</p>
							<h3>Contact</h3>
